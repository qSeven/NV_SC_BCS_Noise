...
if ENABLE_VARIABLE_LC:
    ...
    J_ENHANCEMENT_FILE = HOME_FOLDER+f'/Results/J_enhancement_{TRIAL_NAME}_lc_{COHERENCE_LENGTH:.3f}um.csv'
    T1_ENHANCEMENT_FILE = HOME_FOLDER+f'/Results/T1_enhancement_{TRIAL_NAME}_lc_{COHERENCE_LENGTH:.3f}um.csv'
...
for gap, kbT in zip (gap_K, temperature):
    ...
    for q in qs:
        ...
        J_enhancement.append(current_noise_enhancement(q_tilde, NV_FREQUENCY_K, gap, kbT, FERMI_ENERGY))
